...
namespace Petzold.AdjustTheGradient
{
    class AdjustTheGradient : Window // класс-наследник от класса window
    {
        ...
        public AdjustTheGradient()
        {
            ...
            brush.MappingMode = BrushMappingMode.Absolute; // MappingMode - это способ интерпретации координат, BrushMappingMode - сама система координат, 
        ...
        void WindowOnSizeChanged(object sender, SizeChangedEventArgs args)
        {
            ...
            Vector vectPerp = new Vector(vectDiag.Y, -vectDiag.X); // перпендикуляр к диагонали
